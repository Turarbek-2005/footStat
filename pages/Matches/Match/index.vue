...
<template>
  <div class="tw-pb-3">
    <div class="tw-flex tw-items-center tw-w-full tw-h-96 bg tw-justify-center">
      <div class="tw-flex tw-flex-col tw-items-center tw-container">
        <div class="tw-flex tw-items-center tw-gap-3">
          ...
          >
            <v-img :src="match.competition.emblem" class="tw-h-10 tw-w-10" />
          </div>
        ...
        <div class="tw-grid tw-gap-10 tw-grid-cols-3 tw-items-center">
          ...
          <div class="tw-text-center">
            <div v-if="match.status != 'TIMED'" class="tw-flex tw-flex-col">
